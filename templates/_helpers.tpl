...
app.kubernetes.io/name: {{ include "helm-tutorial.name" . }}
...
*/}}
{{- define "helm-tutorial.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "helm-tutorial.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
